...
def log_loss_(y, y_hat, eps=1e-15):
    ...
    Raises:
        This function should not raise any Exception.
    """
    if y.__class__ != np.ndarray or y_hat.__class__ != np.ndarray or eps.__class__ != float:
        return None
